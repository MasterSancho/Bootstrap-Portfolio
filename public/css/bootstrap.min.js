    ...
    return (
     ...
     (s._jQueryInterface = function (i) {
      return this.each(function () {
       ...
       if (
        (t || ((t = new s(this, e)), P(this).data(j, t)), 'number' == typeof i)
       )
        t.to(i);
    ...
    return (
     ...
     (t._getPopperConfig = function () {
      ...
      'function' == typeof this._config.offset
       ? (t.fn = function (t) {
          return (
           (t.offsets = h({}, t.offsets, e._config.offset(t.offsets) || {})), t
          );
         })
    ...
    return (
     ...
     (t.hide = function (t) {
      ...
      if ((t && t.preventDefault(), !this._isTransitioning && this._isShown)) {
       ...
       if (
        (Bt(this._element).trigger(n), this._isShown && !n.isDefaultPrevented())
       ) {
        this._isShown = !1;
    ...
    return (
     ...
     (n._jQueryInterface = function (e) {
      return this.each(function () {
       ...
       if (
        (t ||
         ((t = new n(this, 'object' == typeof e && e)), Ve(this).data(Be, t)),
        'string' == typeof e)
       ) {
        if ('undefined' == typeof t[e])
         throw new TypeError('No method named "' + e + '"');
